      ...
      <div className="space-y-3">
        {sortedRules.length > 0 && isFirstLayerValid ? (
            ...
            return (
              ...
              >
                ...
                <div className="space-y-1 text-xs">
                  <div>
                    <span className="font-medium">Grid:</span> {rule.cols} ×{' '}
                    {rule.rows}
                  </div>
                  {index === 0 ? (
                    <>
                      ...
                      <div className="pl-2">
                        ...
                        <div>
                          Width: {formatNumber(originalWidth)}, Height:{' '}
                      ...
                      <div className="pl-2">
                        ...
                        <div>
                          Width: {formatNumber(adjustedWidth)}, Height:{' '}
                    ...
                    <div>
                      <span className="font-medium">Subdivision ratio:</span> 1
                      × 1 (last level)
                    </div>
                  ) : (
                    <div>
                      <span className="font-medium">Subdivision ratio:</span>{' '}
          ...
          <div className="text-sm text-gray-500 text-center py-2">
            Please complete at least one grid level above.
          </div>
        )}
      </div>
    </div>
