...
import OperatePanel, { RectangleCoordinates } from "../operatePanel/operatePanel"
...
export function AppSidebarDemo({ onDrawRectangle, rectangleCoordinates, isDrawing, ...props }: AppSidebarDemoProps) {
  return (
    <Sidebar {...props}>
