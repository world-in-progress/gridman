...
import { NodeInformationProps } from './types'
...
export default function NodeInformation({ node }: NodeInformationProps) {
            ...
            <ScrollArea className='h-[80%] overflow-auto'>
                <div className="w-[50%] p-4 space-y-5 ml-[20%] mr-[30%] mb-[5%]">
                    ...
                    <Card className="text-gray-300 bg-neutral-800 transition-all duration-300 hover:translate-y-[-5px] hover:shadow-lg hover:shadow-white/30 hover:border-white/50">
                        <CardHeader>
                            <CardTitle>About Schemas</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <p>Schemas are the fundamental structure for organizing spatial data in the grid system. They define how geographical areas are divided into hierarchical grid cells.</p>
                        </CardContent>
                    ...
                    <Card className="text-gray-300 bg-neutral-800 transition-all duration-300 hover:translate-y-[-5px] hover:shadow-lg hover:shadow-white/30 hover:border-white/50">
                        <CardHeader>
                            <CardTitle>Each schema requires:</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <ul className="list-disc pl-5 space-y-2">
                                <li>A unique name for identification</li>
                    ...
                    <Card className="text-gray-300 bg-neutral-800 transition-all duration-300 hover:translate-y-[-5px] hover:shadow-lg hover:shadow-white/30 hover:border-white/50">
                        <CardHeader>
                            <CardTitle>Why You Need to Create a Schema?</CardTitle>
                        </CardHeader>
                        <CardContent className='space-y-2'>
                            <p>
                                Schemas serve as the essential framework for managing spatial data within a grid - based system. By creating a schema, you establish a standardized and organized way to structure geographical information.
                            </p>
                            <p>
                    ...
                    <p className='text-center text-sm text-gray-300'>
                        If you have already created a schema, you can skip this step.
                    </p>
                    <Button
                        type='button'
